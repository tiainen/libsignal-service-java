...
public interface SignalServiceDataStore {
  ...
  /**
   * @return A {@link SignalServiceAccountDataStoreOld} for the specified account.
   */
  SignalServiceAccountDataStore get(ServiceId accountIdentifier);

  /**
   * @return A {@link SignalServiceAccountDataStoreOld} for the ACI account.
   */
  SignalServiceAccountDataStore aci();

  /**
   * @return A {@link SignalServiceAccountDataStoreOld} for the PNI account.
   */
