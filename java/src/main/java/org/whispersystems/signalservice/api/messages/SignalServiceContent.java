...
import org.whispersystems.signalservice.api.DecryptionErrorMessage; // JV: moved to signal-service
    ...
    if (serviceContentProto.getDataCase() == SignalServiceContentProto.DataCase.LEGACYDATAMESSAGE) {
      ...
      if (message.hasDataMessage()) {
        ...
        return new SignalServiceContent(createTypingMessage(metadata, message.getTypingMessage()),
            ...
            System.err.println("MESSAGE WITH DESCRIPTIONERRORMESSAGE not yet supported, fatal!");
      Thread.dumpStack();
      throw new RuntimeException("Decryptionerrormessage");
...
//                                        serviceContentProto);
  ...
  private static SignalServiceDataMessage createSignalServiceMessage(SignalServiceMetadata metadata,
      ...
      throws UnsupportedDataMessageException, InvalidMessageStructureException, ProtocolInvalidMessageException
  {
...
//    SignalServiceDataMessage.Payment payment = createPayment(content);
  ...
  private static SignalServiceSyncMessage createSynchronizeMessage(SignalServiceMetadata metadata,
      ...
      throws ProtocolInvalidKeyException, UnsupportedDataMessageException, InvalidMessageStructureException, ProtocolInvalidMessageException
  {
    if (content.hasSent()) {
    ...
    if (content.getViewedList().size() > 0)  {
          System.err.println("VIEWEDLIST not yet sypported, ignore");
    Thread.dumpStack();
...
//          Optional<UUID>                                             recipient  = Optional.ofNullable(UuidUtil.parseOrNull(outgoingPayment.getRecipientUuid()));
//
  ...
  private static SignalServiceCallMessage createCallMessage(SignalServiceProtos.CallMessage content) {
    ...
    if (content.hasOffer()) {
      ...
      return SignalServiceCallMessage.forBusy(new BusyMessage(busy.getId()), isMultiRing, destinationDeviceId);
        ...
        System.err.println("OPAQUE MESSAGE NOT SUPPORTED");
        Thread.dumpStack();
        throw new RuntimeException("opaque call not supported");
...
//      return SignalServiceCallMessage.forOpaque(new OpaqueMessage(opaque.getData().toByteArray(), null), isMultiRing, destinationDeviceId);
  ...
  private static SignalServiceTypingMessage createTypingMessage(SignalServiceMetadata metadata, SignalServiceProtos.TypingMessage content)
          throws InvalidMessageStructureException, ProtocolInvalidMessageException  {
  ...
  private static SignalServiceDataMessage.Quote createQuote(SignalServiceProtos.DataMessage content, boolean isGroupV2)
      throws  InvalidMessageStructureException, InvalidMessageStructureException, ProtocolInvalidMessageException
  {
  ...
  private static List<SignalServiceDataMessage.Preview> createPreviews(SignalServiceProtos.DataMessage content) throws 
          InvalidMessageStructureException, ProtocolInvalidMessageException {
  ...
  private static SignalServiceDataMessage.Sticker createSticker(SignalServiceProtos.DataMessage content) throws 
          InvalidMessageStructureException, ProtocolInvalidMessageException {
...
//  }
  ...
  private static List<SharedContact> createSharedContacts(SignalServiceProtos.DataMessage content) throws ProtocolInvalidMessageException, InvalidMessageStructureException {
