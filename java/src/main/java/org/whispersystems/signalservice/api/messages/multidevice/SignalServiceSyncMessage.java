...
public class SignalServiceSyncMessage {
  ...
  public static SignalServiceSyncMessage forCallEvent(CallEvent callEvent) {
    return new SignalServiceSyncMessage(Optional.empty(),
                                        Optional.empty(),
                                        Optional.empty(),
                                        Optional.empty(),
  ...
  public static SignalServiceSyncMessage forCallLinkUpdate(CallLinkUpdate callLinkUpdate) {
    return new SignalServiceSyncMessage(Optional.empty(),
                                        Optional.empty(),
                                        Optional.empty(),
                                        Optional.empty(),
  ...
  public static SignalServiceSyncMessage forCallLogEvent(CallLogEvent callLogEvent) {
    return new SignalServiceSyncMessage(Optional.empty(),
                                        Optional.empty(),
                                        Optional.empty(),
                                        Optional.empty(),
